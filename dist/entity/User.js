...
__decorate([
    typeorm_1.Column({ length: 60, name: "last_name" }),
    __metadata("design:type", String)
...
__decorate([
    typeorm_1.Column({ length: 12, nullable: true }),
    __metadata("design:type", String)
], User.prototype, "dni", void 0);
__decorate([
    typeorm_1.Column({ length: 250, nullable: false }),
    __metadata("design:type", String)
...
__decorate([
    typeorm_1.OneToMany((type) => Inscription_1.Inscription, (ins) => ins.user),
